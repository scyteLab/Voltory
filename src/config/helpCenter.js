...
export const HELP_TOPICS = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Every product on Voltory is sourced from authorised distributors and comes with the full manufacturer warranty. We do not stock refurbished, parallel-import, or unbranded items. If anything ever arrives that doesn\u2019t look authentic, contact us within 7 days and we\u2019ll replace or refund it immediately.",
      },
      {
    ...
    items: [
      {
        ...
        a: "Yes. Every product on Voltory carries the manufacturer\u2019s official warranty \u2014 typically 1 year on most appliances, and up to 10 years on AC compressors from certain brands. The warranty period is shown on each product page.",
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        q: "Is it safe to pay with my card on Voltory?",
        a: "Yes. We never see or store your card details \u2014 all card payments are processed by Paystack, the most widely-used PCI-DSS Level 1 certified payment processor in Nigeria. The same security that protects your bank app protects your Voltory checkout.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Email us at " + "support@voltory.ng" + " from the email address linked to your account, and we\u2019ll process the deletion within 7 days. Note: order history is retained for accounting purposes per Nigerian tax law, but no personal data remains visible after deletion.",
      },
    ],
  },
];
