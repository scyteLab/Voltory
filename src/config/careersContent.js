...
export const CAREERS_ROLES = [
  {
    ...
    type: "Full-time",
    snapshot:
      "Run order fulfillment end-to-end: stock allocation, dispatch coordination, delivery partner relationships, returns processing.",
    youll: [
      "Own the order pipeline from confirmation through delivery",
      "Coordinate with brand distributors and logistics partners",
      "Build our SOPs for inventory, dispatch, and exception handling",
      "Track operational KPIs and surface improvement opportunities",
    ],
    looking: [
      "3+ years in operations or supply chain (FMCG / e-commerce / 3PL)",
      "Excel fluency including pivot tables and basic dashboards",
      "Calm under pressure with strong follow-through",
      "Comfortable owning outcomes without daily oversight",
    ],
    bonus: "Experience with appliance, electronics, or large-format goods is a plus.",
  },
  {
    id: "customer-success",
    ...
    youll: [
      ...
      "Surface recurring issues to operations and product",
    ],
    looking: [
  ...
  {
    id: "field-tech-lagos",
    title: "Field Installation Technician (Lagos)",
    department: "Installation Network",
  ...
  },
  {
    ...
    type: "Full-time",
    snapshot:
      "Get every order to the customer faster, safer, and cheaper. Manage rider pools, courier partnerships, and route planning.",
    youll: [
      "Schedule daily dispatch waves and manage rider/3PL assignments",
      "Negotiate freight rates with logistics partners across regions",
      "Investigate late or failed deliveries; close the loop with customers",
      "Build the data backbone (dispatch logs, delivery times, exception rates)",
    ],
    looking: [
      "2+ years dispatch or last-mile logistics experience",
      "Comfortable with maps, route optimisation tools, and Excel",
      "Calm crisis management when things go wrong (because they will)",
      "Negotiation skills with rider unions and third-party couriers",
    ],
    bonus: "Direct experience with Lagos delivery dynamics is invaluable.",
  },
];
...
export const CAREERS_VALUES = [
  ...
  {
    icon: "Eye",
    title: "Ownership, not roles",
    body:
      "Job descriptions are starting points, not ceilings. The fastest path to seniority here is to make problems disappear.",
  },
  {
    icon: "Heart",
...
export const CAREERS_BENEFITS = [
  "Competitive salary benchmarked against the Nigerian market for your role and experience",
  "Health insurance enrolment from day one (full-time roles)",
  "Performance bonuses tied to clear, measurable outcomes",
  "Equity participation for early team members in lead roles",
  "Learning budget for courses and certifications relevant to your function",
  "Real-world ownership: ship work that customers see, not slideware",
];
